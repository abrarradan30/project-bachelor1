...
@if(in_array(Auth::user()->role, ['admin', 'siswa', 'mentor']))
                ...
                <div class="inner-wrapper">
                                                ...
                                                <div class="simplebar-content" style="padding: 16px;">
                                                    <nav class="nav nav-pills nav-gap-y-1 flex-column">
                                                        <a href="javascript:void(0)"
                                                            class="nav-link nav-link-faded has-icon active">Semua
                                                            Diskusi</a>
                                                        <a href="javascript:void(0)"
                                                            class="nav-link nav-link-faded has-icon">Selesai</a>
                                                        <a href="javascript:void(0)"
                                                            class="nav-link nav-link-faded has-icon">Belum Selesai</a>
                                                    </nav>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="inner-main">
                        ...
                        <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
                            ...
                            <a href="{{ url('forum') }}" class="btn btn-light btn-sm mb-3 has-icon"><i
                                    ...
                                    <div class="card-body">
                                        <div class="media forum-item">
                                            ...
                                            <div class="media-body">
                                                <a href="{{url('forum/show/' . $fd->id) }}" data-toggle="collapse"
                                                    data-target=".forum-content" class="text-body"> {!! $fd->pertanyaan !!} </a>
                                                <p class="text-muted"><a href="javascript:void(0)"></a>
                                                    <br>
                                                    <span
                                                        class="text-secondary font-weight-bold">{{ \Carbon\Carbon::parse($fd->created_at)->format('d-M-Y') }}</span>
                                                </p>
    ...
    @endif
                                        ...
                                        <div class="media forum-item">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="text-muted"><a href="javascript:void(0)"></a>
                                                    <br>
                                                    <span
                                                        class="text-secondary font-weight-bold">{{ \Carbon\Carbon::parse($bd->created_at)->format('d-M-Y') }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="inner-main-body p-2 p-sm-3 collapse forum-content" data-toggle="collapse"
                ...
                <div class="modal fade" id="pertanyaanModal" tabindex="-1" role="dialog"
                    aria-labelledby="pertanyaanModalLabel" aria-hidden="true">
                            ...
                            <form>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="threadTitle" placeholder="Pilih Judul"
                                            autofocus />
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label for="pertanyaan">Pertanyaan</label>
                                        <textarea class="form-control" id="pertanyaan"
                            ...
                            <form method="POST" action="{{ url('forum_balas/store_balas') }}" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($forum_diskusi as $fd)
                                            <textarea class="form-control summernote" id="forum_diskusi_id"
                                                name="forum_diskusi_id" readonly>{{ strip_tags($fd->pertanyaan) }}</textarea>
